...
const Temp = () => {
  ...
  const getWeatherInfo = async () => {
    try {
      let url = `https://cors-anywhere.herokuapp.com/http://api.openweathermap.org/data/2.5/weather?q=${searchValue}&units=metric&appid=84f2622ba538e60ec23afb8154b1fcaf`;
